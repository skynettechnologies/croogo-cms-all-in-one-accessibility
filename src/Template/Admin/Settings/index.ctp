...
<?= $this->Html->css('Allinoneaccessibility.bootstrap.min') ?>
<?= $this->Html->css('Allinoneaccessibility.style') ?>
<?= $this->Html->css('Allinoneaccessibility.style.css') ?>

<?= $this->Html->script('Allinoneaccessibility.bootstrap.bundle.min') ?>
...
<script>
  ...
  $(document).ready(function() {
    ...
    const url = <?php echo json_encode($request['url']); ?>;


    const username = <?php echo isset($request['username']) ? json_encode($request['username']) : '""'; ?>;
    const email = <?php echo isset($request['email']) ? json_encode($request['email']) : '""'; ?>;
