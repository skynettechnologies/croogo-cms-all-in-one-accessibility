# All in One Accessibility®: Croogo CMS Plugin
...
1: Place Allinoneaccessibility.zip into "Plugins" folder and extract it
2: After extraction, you can see it in admin panel at "Extensions >> Plugins"
3: There you can see the Allinoneaccessibility in list and at the end you can see the option to install/enable/disable etc...
